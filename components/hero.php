...
<div class="flex flex-col items-center text-gray-100 text-center gap-20 py-20">
    <img src="../assets/dev.png" alt="Dev image" width="144" height="144">
    <div class="gap-2 flex flex-col items-center justify-center">
        <p class="intro text-[20px]">Hello World! Meu nome é <span class="text-red-400"> <?= $name ?> </span> e sou</p>
        <h1 class="job-title text-[56px]"><?= $job ?></h1>
        <p class="job-description text-gray-400 text-[14px] w-1/2"><?= $description ?></p>
    </div>
    <div class="stack">
